# 72c12bfa-2a23-4a7d-ad3b-8ed033e04876 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `icon-system-upgrade.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
- Primary entry: `icon-system-upgrade.html`
...
- A single self-contained `icon-system-upgrade.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `icon-system-upgrade.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `brand-spec.md`
- `icon-system-upgrade.png`

## Coding checklist for AI tools

1. Inspect `icon-system-upgrade.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
