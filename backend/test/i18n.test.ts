...
describe('i18n middleware', () => {
  ...
  it('detects Turkish from Accept-Language header', () => {
    const middleware = createI18nMiddleware();
    const req = { headers: { 'accept-language': 'tr-TR,tr;q=0.9,en;q=0.8' } } as unknown as Request;
    const res = {} as unknown as Response;
  ...
  it('falls back to English for unknown language', () => {
    const middleware = createI18nMiddleware();
    const req = { headers: { 'accept-language': 'fr-FR,fr;q=0.9' } } as unknown as Request;
    const res = {} as unknown as Response;
    middleware(req, res, (() => {}) as NextFunction);
  ...
  it('handles malformed Accept-Language header', () => {
    const middleware = createI18nMiddleware();
    const req = { headers: { 'accept-language': '' } } as unknown as Request;
    const res = {} as unknown as Response;
    middleware(req, res, (() => {}) as NextFunction);
  ...
  it('handles undefined Accept-Language header', () => {
    const middleware = createI18nMiddleware();
    const req = { headers: { 'accept-language': undefined } } as unknown as Request;
    const res = {} as unknown as Response;
    middleware(req, res, (() => {}) as NextFunction);
  ...
  it('translates all major error categories in Turkish', () => {
    const middleware = createI18nMiddleware();
    const req = { headers: { 'accept-language': 'tr' } } as unknown as Request;
    const res = {} as unknown as Response;
    middleware(req, res, (() => {}) as NextFunction);
