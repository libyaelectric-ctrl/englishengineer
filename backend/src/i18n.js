const translations = {
  en: {
    ...
    'free_ai_coach_limit_exceeded': 'Free plan accounts are limited to 3 AI Coach requests per day. Please upgrade to Pro.',
    'monthly_ai_credit_limit_exceeded': 'Monthly AI credit limit reached (300/300). Please contact support or upgrade.',
  ...
  tr: {
    ...
    'free_ai_coach_limit_exceeded': 'Ücretsiz plan hesapları günde 3 AI Koç isteği ile sınırlıdır. Pro planına yükseltin.',
    'monthly_ai_credit_limit_exceeded': 'Aylık AI kredi limiti doldu (300/300). Destek ile iletişime geçin veya yükseltme yapın.',
