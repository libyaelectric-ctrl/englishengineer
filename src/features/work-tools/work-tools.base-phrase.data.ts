...
export const BASE_PHRASE_LIBRARY: BasePhraseEntry[] = [
  {
    id: 'consultant-01',
    category: 'Consultant',
    phrase: 'The revised submission addresses each comment in the attached response sheet.',
  ...
  },
  {
    ...
    turkishMeaning: 'Telafi aksiyonunu ve taahhut edilen bitis tarihini teyit edin.',
  ...
  },
  {
    ...
    turkishMeaning: 'Bu secenek onayli performans kriterlerini korurken kilometre tasini da korur.',
  ...
  },
  {
    ...
    phrase: 'Do not proceed beyond this point until the inspection is released.',
    turkishMeaning: 'Kontrol serbest birakilmadan bu noktadan sonra devam etmeyin.',
  ...
  },
  {
    id: 'qaqc-01',
    category: 'QA/QC',
    phrase: 'The close-out evidence must be traceable to the original observation.',
  ...
  },
  {
    id: 'hse-01',
    category: 'HSE',
    phrase: 'The immediate risk has been removed and a preventive control is now in place.',
    turkishMeaning: 'Anlik risk giderildi ve onleyici kontrol uygulamaya alindi.',
  ...
  },
  {
    ...
    phrase: 'Please identify any approval or manufacturing constraint affecting the ex-works date.',
    turkishMeaning: 'Fabrika cikis tarihini etkileyen onay veya uretim engelini belirtin.',
  ...
  },
  {
    ...
    turkishMeaning: 'Tum on kosul kontrolleri imzalanmadan sistem entegre teste sunulamaz.',
  ...
  },
  {
    id: 'approval-01',
    category: 'Approval',
    phrase: 'Approval is required by Thursday to avoid an impact on procurement.',
    turkishMeaning: 'Tedarike etki etmemesi icin perşembe gününe kadar onay gereklidir.',
    usageContext: 'Time-sensitive submission',
    example: 'Approval is required by Thursday to avoid an impact on procurement and delivery.',
  },
  {
    id: 'rejection-01',
    category: 'Rejection',
    ...
    turkishMeaning: 'Gerekli aciklik gosterilmedigi icin teklif mevcut haliyle kabul edilemez.',
  ...
  },
  {
    ...
    phrase: 'Please confirm which document takes precedence for this interface.',
    turkishMeaning: 'Bu arayuz icin hangi dokumanin oncelikli oldugunu teyit edin.',
  ...
  },
  {
    id: 'follow-up-01',
    category: 'Follow-up',
    phrase: 'This action remains open and is now affecting the planned start date.',
    turkishMeaning: 'Bu aksiyon hala acik ve planlanan baslangic tarihini artik etkiliyor.',
