...
export const SPECIALIST_FEATURES: BillingFeature[] = [
  ...SENIOR_FEATURES,
  'speaking',
  'listening',
  'realVoiceSpeaking',
...
export const BILLING_PLANS: Record<BillingPlanId, BillingPlan> = {
  ...
  junior: {
    ...
    name: 'Junior',
    description:
      'Essential learning core: placement test, vocabulary, grammar, and progress tracking.',
    isFutureReady: false,
