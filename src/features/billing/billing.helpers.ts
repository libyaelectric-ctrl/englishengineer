...
export const BILLING_PLANS: Record<BillingPlanId, BillingPlan> = {
  free: {
    ...
    name: 'Free',
    description:
      'Limited EngineerOS access for evaluation and learning warm-up.',
    isFutureReady: false,
    features: [
      'reading',
      'writing',
  ...
  pro: {
    ...
    name: 'Pro',
    description:
      'Unlimited engineering English practice with advanced analytics and full gamification.',
    isFutureReady: false,
    features: [
      'reading',
      'writing',
  ...
  enterprise: {
    ...
    name: 'Enterprise',
    description:
      'Future-ready team, administration, procurement and custom deployment tier.',
    isFutureReady: true,
    features: [
      'reading',
      'writing',
