  ...
  return (
    <div className="flex w-full max-w-xl flex-col items-center gap-6 text-center font-sans">
      <div className="flex flex-col items-center gap-2">
        ...
        {term.partOfSpeech && (
          <span className="text-xs font-mono uppercase tracking-widest text-[var(--color-muted-copy)]">[{term.partOfSpeech}]</span>
        )}
        <p className="mt-2 text-sm text-[var(--color-muted-copy)] max-w-md">
          Select the correct engineering definition / translation for this specification term:
        </p>
      </div>
