...
export const INTERMEDIATE_LISTENING_MISSIONS: ListeningMission[] = [
  {
    ...
    estimatedMinutes: 12,
    audioUrl: '/audio/list_site_meeting.mp3',
  ...
  },
  {
    ...
    difficulty: 'Intermediate',
    estimatedMinutes: 10,
    audioUrl: '/audio/list_fat_meeting.mp3',
  ...
  },
  {
    ...
    difficulty: 'Intermediate',
    estimatedMinutes: 11,
    audioUrl: '/audio/list_cable_routing.mp3',
  ...
  },
  {
    ...
    difficulty: 'Beginner',
    estimatedMinutes: 8,
    audioUrl: '/audio/list_safety_toolbox.mp3',
  ...
  },
  {
    ...
    difficulty: 'Intermediate',
    estimatedMinutes: 10,
    audioUrl: '/audio/list_project_progress.mp3',
