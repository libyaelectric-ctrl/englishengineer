    ...
    <div className="flex flex-col gap-2 mt-4 pt-4 border-t border-border-soft">
      ...
      <div className="flex gap-1.5 overflow-x-auto py-1 custom-scrollbar">
        {days.map((day, i) => {
          ...
          if (score > 0 && score <= 50) levelClass = 'bg-green-200 border-green-300 dark:bg-green-900/40 dark:border-green-800';
          if (score > 50 && score <= 200) levelClass = 'bg-green-400 border-green-500 dark:bg-green-700 dark:border-green-600';
          if (score > 200) levelClass = 'bg-green-600 border-green-700 dark:bg-green-500 dark:border-green-400';
          ...
          return (
            <div
              ...
              className={cn(
                ...
                levelClass,
                i === 29 && "ring-2 ring-primary ring-offset-1 ring-offset-background" // highlight today
              )}
            />
          );
        })}
