...
const DEFAULT_DESCRIPTION = 'Master engineering English with AI-powered learning, vocabulary building, and professional communication practice.';
...
export const SEO: React.FC<SEOProps> = ({
  ...
  return (
    <Helmet>
      ...
      <meta name="image" content={image.startsWith('http') ? image : `${baseUrl}${image}`} />
