  ...
  return (
    <>
      <div className="px-4 pt-4">
        <SkillEntryBrief skill={config.skill as 'vocabulary' | 'grammar' | 'reading' | 'writing' | 'listening' | 'speaking'} compact={true} />
      </div>
        ...
        <div className="space-y-3">
          <div>
            <p className="text-[10px] font-bold text-primary tracking-wider uppercase mb-1">
              {config.currentLevel || 'Loading'} PATH ·{' '}
              {config.totalItems ?? 0} ITEMS
            </p>
