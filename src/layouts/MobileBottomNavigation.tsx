...
const ITEMS = [
  ...
  { label: 'Skills', href: null, icon: BookMarked },
    ...
    >
      ...
      {skillsOpen && (
        <>
          ...
          />
          <div className="absolute bottom-full left-2 right-2 z-50 mb-2 rounded-[var(--radius-card)] border border-border-soft bg-surface shadow-xl p-2 grid grid-cols-3 gap-1.5">
