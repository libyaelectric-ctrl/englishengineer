  ...
  return (
    <>
      {isSidebarOpen && (
        <button
          type="button"
          className="fixed inset-0 z-30 border-0 bg-slate-950/55 backdrop-blur-sm lg:hidden"
      ...
      <nav
        ...
        className={cn(
          'fixed inset-y-0 left-0 z-40 flex flex-col border-r border-sidebar-border bg-sidebar-bg backdrop-blur-xl transition-all lg:static lg:flex lg:translate-x-0',
      ...
      >
        <div className="flex h-screen flex-col overflow-hidden bg-transparent">
          ...
          />
          {!isSidebarCollapsed && (
            <div className="flex items-center gap-1 border-b border-sidebar-inner-border px-3 py-2">
              {altLang && (
                <button
                  type="button"
                  onClick={() => {
                  ...
                  className="h-8 rounded-[var(--radius-button)] border border-border-soft bg-surface px-2 text-[9px] font-black uppercase text-foreground hover:bg-surface-hover"
                >
              ...
              <button
                ...
                className="h-8 rounded-[var(--radius-button)] border border-border-soft bg-surface px-2 text-[9px] font-black text-foreground hover:bg-surface-hover"
              >
                EN
              </button>
              <ThemeToggle />
              <button
                ...
                className="ml-auto cursor-pointer border-0 bg-transparent text-muted-copy hover:text-foreground lg:hidden"
              >
                <X size={16} />
              </button>
            </div>
