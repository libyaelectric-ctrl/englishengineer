  ...
  <div className="rounded-[4px] border border-border-soft bg-surface-hover p-4 space-y-3 shadow-sm">
    ...
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
      <input
        ...
        disabled={!allowed}
        className="text-xs text-muted-copy file:mr-3 file:py-1 file:px-2.5 file:rounded-[4px] file:border file:border-border-soft file:text-[10px] file:font-bold file:uppercase file:tracking-wider file:bg-surface file:text-primary hover:file:bg-surface-hover cursor-pointer disabled:cursor-not-allowed disabled:opacity-50 disabled:cursor-not-allowed"
      />
