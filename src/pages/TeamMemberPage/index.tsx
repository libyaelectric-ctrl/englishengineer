...
const TeamMemberPage = () => {
  ...
  return (
    <main className="space-y-6 pt-12 sm:pt-0">
      ...
      >
        {!member || !summary ? (
          <div className="rounded-[var(--radius-card)] border border-border-soft bg-surface p-8 text-center">
          ...
          <div className="space-y-5">
            ...
            <section className="rounded-[var(--radius-card)] border border-border-soft bg-surface p-5">
