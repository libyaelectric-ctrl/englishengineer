  ...
  return (
    <aside className="space-y-5">
      ...
      >
        <label className="text-xs font-bold uppercase tracking-wider text-foreground">
          ...
          <select
            ...
            className="mt-2 min-h-10 w-full rounded-[4px] border border-border-soft bg-surface px-3 text-xs font-bold uppercase tracking-wider text-foreground cursor-pointer focus:border-primary focus:ring-0 shadow-sm"
          >
            {DOMAINS.map((item) => (
      ...
      >
        ...
        <Link
          to="/placement"
          className="mt-4 w-full h-9 inline-flex items-center justify-center rounded-[4px] border border-border-soft bg-surface hover:bg-surface-hover text-xs font-bold uppercase tracking-wider text-primary cursor-pointer shadow-sm"
        >
