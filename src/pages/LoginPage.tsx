...
const LoginPage = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#faf8ff] text-foreground relative overflow-hidden">
      ...
      <div className="flex flex-1 items-center justify-center p-6 relative z-10">
        <div className="w-full max-w-md rounded-[4px] border border-[#d9d9e3] bg-white p-8 shadow-sm space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          <p className="text-center text-xs text-muted-copy font-bold uppercase tracking-wider">
            ...
            <button
              ...
              className="font-bold text-[#0047bb] hover:underline cursor-pointer"
            >
          ...
          {h.isLocalDemoMode && (
            <div className="text-center border-t border-[#d9d9e3] pt-4">
              <button
                type="button"
                onClick={h.handleDemoSubmit}
                disabled={h.isLoading}
                className="text-xs font-bold uppercase tracking-wider text-[#0047bb] hover:underline cursor-pointer transition-colors"
              >
                Try demo mode →
              </button>
          ...
          <p className="text-center text-[10px] text-muted-copy font-bold uppercase tracking-wider">
            ...
            <Link to="/legal/terms" className="underline hover:text-[#0047bb]">
              Terms
            </Link>{' '}
            and{' '}
            <Link
              to="/legal/privacy"
              className="underline hover:text-[#0047bb]"
            >
              Privacy Policy
            </Link>
            .
