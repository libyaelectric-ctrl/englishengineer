...
const LoginPage = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#faf8ff] text-foreground relative overflow-hidden dark:bg-[#0B0E14]">
      ...
      <div className="flex flex-1 items-center justify-center p-6 relative z-10">
        <div className="w-full max-w-md rounded-[4px] border border-[#d9d9e3] bg-white p-8 shadow-sm space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300 dark:border-[#2a2d35] dark:bg-[#1C1F26]">
          <div className="text-center">
            <h1 className="text-sm font-bold uppercase tracking-widest text-foreground font-mono dark:text-[#E2E4E7]">
              {h.isSignUpMode ? copy.signupTitle : copy.loginTitle}
            </h1>
            <p className="mt-1.5 text-xs font-medium text-muted-copy dark:text-[#949BA4]">
          ...
          <p className="text-center text-xs text-muted-copy font-bold uppercase tracking-wider dark:text-[#949BA4]">
          ...
          {h.isLocalDemoMode && (
            <div className="text-center border-t border-[#d9d9e3] pt-4 dark:border-[#2a2d35]">
              <button
                type="button"
              ...
              <p className="mt-1 text-[9px] font-bold text-muted-copy uppercase tracking-wider dark:text-[#949BA4]">
                {copy.demoMessage}
              </p>
            </div>
          )}

          <p className="text-center text-[10px] text-muted-copy font-bold uppercase tracking-wider dark:text-[#949BA4]">
