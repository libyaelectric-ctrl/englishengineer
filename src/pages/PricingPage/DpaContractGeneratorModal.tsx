import { CheckCircle2, Download, FileCheck, X } from 'lucide-react';
...
export const DpaContractGeneratorModal = ({ isOpen, onClose }: DpaContractGeneratorModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-md p-4 animate-in fade-in">
      <div className="w-full max-w-lg rounded-[var(--radius-card)] border border-primary/30 bg-surface/95 p-5 shadow-2xl space-y-4 relative light-sweep-container overflow-hidden">
        ...
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className={`rounded-[var(--radius-card)] border p-3 text-left transition cursor-pointer ${
              contractType === 'dpa'
        ...
        <div className="rounded-[var(--radius-card)] border border-primary/20 bg-background/80 p-3 space-y-1 text-xs font-mono text-muted-copy">
