    ...
    <div className="mt-2 flex gap-2 overflow-x-auto pb-1">
      {reviewTargets.map(({ rule, status }) => (
        <button
          ...
          className="flex shrink-0 items-center gap-2 rounded-[4px] border border-border-soft bg-background px-3 py-2 text-left hover:border-warning/40 cursor-pointer"
        >
