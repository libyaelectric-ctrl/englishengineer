  ...
  privacy: {
    ...
    sections: [
      [
        ...
        'EngVox Operating Systems Inc. ("EngVox", "we", "us", or "our") acts as the Data Controller responsible for your personal information. For all data privacy inquiries, exercising data subject rights, or contacting our Data Protection Officer (DPO), please email dpo@engvox.com or privacy@engvox.com.',
      ],
      [
      ...
      [
        ...
        'Account credentials and workspace state are retained only while your account remains active. Anonymized performance metrics are pruned after 90 days. Users may trigger instant, automated account deletion and workspace purge from their Profile settings or by emailing privacy@engvox.com.',
      ],
      [
