...
export const StyleGuidelines = ({
  ...
  <div className="space-y-3 rounded-[4px] border border-border-soft bg-surface-hover p-5 shadow-sm">
    <h5 className="text-xs font-bold uppercase text-muted-copy tracking-wider flex items-center gap-1.5">
      ...
      <span>
        Linguistic Guideline Insights ({corrections.length - activeCorrections.length}/
    ...
    {selectedRule ? (
      ...
      <div className="space-y-2">
        <p className="text-xs text-muted-copy italic py-1 font-medium">
          Click on any linguistic flag in the right column checkpoint, or review the brief outline
          of required revisions below:
        </p>
