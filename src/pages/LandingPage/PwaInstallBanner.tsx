...
export const PwaInstallBanner = () => {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 pb-6">
      <div className="rounded-xl border border-primary/30 bg-surface/95 backdrop-blur-md p-2.5 shadow-lg space-y-1.5 light-sweep-container overflow-hidden">
        ...
        {installed ? (
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <button
              ...
              className="inline-flex items-center gap-1 rounded-lg bg-primary px-2 py-1 text-[10px] font-bold text-primary-foreground hover:bg-primary-hover transition cursor-pointer shadow-sm shrink-0"
            >
