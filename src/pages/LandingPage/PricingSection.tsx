      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 items-stretch">
          {LANDING_PLANS.map((plan, index) => {
            ...
            const discountedUsd = isAnnual ? Math.round(basePrice * 0.8) : basePrice;
            const displayPrice = CurrencyConfig.formatPrice(discountedUsd, selectedCurrency);
            ...
            return (
              ...
              >
                {/* ITEM 16: Border-Beam Glowing Halo for Pro Plan */}
                {isPrimary && (
