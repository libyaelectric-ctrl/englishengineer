    ...
    <nav className="dark:bg-[#0B0E14]/80 fixed inset-x-0 top-0 z-50 flex justify-center border-b border-[#d9d9e3] bg-[#faf8ff]/80 py-4 backdrop-blur-xl dark:border-[#2a2d35]">
      <div className="flex w-full max-w-7xl items-center justify-between px-6">
        ...
        <div className="hidden items-center gap-7 text-[11px] font-bold uppercase tracking-wider md:flex">
          <Link to="/pricing" className="text-muted-copy transition-colors hover:text-black dark:text-[#949BA4] dark:hover:text-[#E2E4E7]">
            Pricing
          </Link>
        </div>
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex h-10 w-10 items-center justify-center rounded-[4px] border border-[#d9d9e3] bg-white/60 text-black/60 transition hover:bg-black/[0.04] dark:border-[#2a2d35] dark:bg-[#1C1F26] dark:text-[#949BA4] dark:hover:bg-[#252830] cursor-pointer"
          >
