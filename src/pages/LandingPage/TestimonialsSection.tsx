...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    quote:
      'I went from struggling to write site reports to submitting them confidently in two months. The discipline-specific vocabulary changed everything.',
    rating: 5,
  ...
  },
  {
    ...
    quote:
      'Finally, an English tool that speaks my technical language. I can now lead commissioning meetings without a translator.',
    rating: 5,
  ...
  },
  {
    ...
    quote:
      'The daily streak keeps me consistent. I have not missed a day in 40 days. My NCR responses are now written entirely in English.',
    rating: 5,
  ...
  },
  {
    ...
    quote:
      'I selected Mechanical Engineering as my discipline and every word, every reading passage is relevant to my daily work. No generic content.',
    rating: 5,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {TESTIMONIALS.map((testimonial, idx) => (
            <motion.div
              ...
              className="relative p-6 lg:p-8 rounded-[var(--radius-card)] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-lg transition-all"
            >
              ...
              <div className="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-slate-800">
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400">
                    {testimonial.role} · {testimonial.discipline}
                  </p>
                </div>
