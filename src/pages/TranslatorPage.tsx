  ...
  return (
    <main className="mx-auto w-full max-w-4xl space-y-6 pb-12 animate-in fade-in">
      ...
      <div className="rounded-2xl border border-primary/30 bg-surface/95 p-6 shadow-xl space-y-5 relative">
          ...
          <div className="space-y-2 relative">
              ...
              <label className="text-xs font-bold text-foreground flex items-center gap-2">
                ...
                {inputText.trim() && (
                  <button
                    type="button"
                    onClick={() =>
                      speakText(inputText, sourceLang === 'tr' ? 'tr' : 'en', 'source')
                    }
            ...
            {!autoTranslateEnabled && (
              <button
                ...
                className="w-full py-2.5 rounded-xl bg-primary text-primary-foreground text-xs font-bold hover:bg-primary-hover transition cursor-pointer shadow-md disabled:opacity-50 flex items-center justify-center gap-2"
              >
                <Zap className="h-4 w-4" /> Translate Text Now
              </button>
            )}
          </div>
        ...
        {/* Single-Word Part of Speech & Technical Synonyms Card */}
