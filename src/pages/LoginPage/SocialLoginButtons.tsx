      ...
      {SOCIAL_PROVIDERS.map((sp) => {
        ...
        return (
          <button
            ...
            className="flex h-10 w-full items-center justify-center gap-2.5 rounded-[var(--radius-card)] border border-border-soft bg-surface text-xs font-bold text-foreground transition-all hover:bg-surface-hover hover:border-primary/50 disabled:cursor-not-allowed disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer shadow-sm"
          >
            {isLoading ? (
