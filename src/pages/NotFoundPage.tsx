...
const NotFoundPage = () => (
  <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
    <div className="p-6 bg-rose-500/10 rounded-full mb-8 text-rose-500 animate-pulse">
      <ShieldAlert className="h-16 w-16" />
    </div>
    <h1 className="text-6xl font-black tracking-tighter">404 LOGIC FAULT</h1>
    ...
    <Link to="/dashboard" className="mt-12">
      <Button variant="outline" className="gap-3 px-8 h-14 text-lg">
