...
test.describe('EngineerOS Olympus real browser verification (Firebase + free tier)', () => {
  test('startup, Firebase sign-in, dashboard persistence, and logout', async ({ page }) => {
    await page.goto('/');
    await expect(
