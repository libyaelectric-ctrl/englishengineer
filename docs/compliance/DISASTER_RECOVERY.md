...
*Description:* Vercel's global CDN or edge network experiences a severe downtime affecting application routing.
*Action:*
...
*Description:* Accidental DROP TABLE or complete primary database corruption.
*Action:*
...
*Description:* OpenAI API goes down, causing AI teacher components to fail.
*Action:*
